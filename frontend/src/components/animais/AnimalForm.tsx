...
export function AnimalForm({
  ...
  const [statusSaude, setStatusSaude] = useState<StatusSaude>((initial?.status_saude as StatusSaude) ?? 'SAUDAVEL')
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={statusSaude} onValueChange={(v) => setStatusSaude(v as StatusSaude)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
