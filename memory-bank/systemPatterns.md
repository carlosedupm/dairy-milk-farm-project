...
- **Conformidade (dois âmbitos)**: `ConformidadeService` — INT-001 a INT-006 com `repository.SQLNoRebanhoFor("a")` (só rebanho ativo, BR-AUDIT-009); INT-007 apenas animais com `data_saida <= hoje` e ciclo aberto (BR-BAIXA-003). Constante partilhada com listagens em `animal_repository.go`.
