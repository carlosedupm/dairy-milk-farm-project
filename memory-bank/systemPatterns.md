...
**Versão dos Padrões**: 2.24 (Go + Next.js) — Pickers data/hora Dialog unificado + selects nativos hora/min.

**Última atualização**: 2026-05-23 (pickers — Dialog em todos os breakpoints; visibilidade universal)
