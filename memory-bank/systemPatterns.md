...
- **Tabelas**: CioTable, CoberturaTable, PartoTable, LactacaoTable, etc. em `components/gestao/` — usam `useAnimaisMap`, Table Shadcn, formatDate em pt-BR. **Cios** e **Coberturas** incluem **Editar** e **Excluir** (Dialog de confirmação).
