...
**Última atualização**: 2026-05-07 (Lint CI: `set-state-in-effect` + `no-unescaped-entities` corrigidos — `useMediaQuery` com `useSyncExternalStore`; reset de offset por estado derivado)
