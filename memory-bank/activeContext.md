...
**Foco atual:** validação operacional Tier 0 em staging e backlog Tier 2 (M2M produção/partos, testes de integração).
...
2. **Validação manual G3** — BRF-006 (geração admin/cron) e BRF-007 (assistente no curral com perfil `FUNCIONARIO`).
