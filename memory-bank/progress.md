...
- [x] **BRF-010** (`aprovado`, G3 pendente) — cio obrigatório na cobertura; cobertura em prenhe fecha gestação `PERDA`; campos IA MVP; delete→status; cio silencioso (`BR-COBERTURAS-008`–`011`, `BR-CIOS-006`)
