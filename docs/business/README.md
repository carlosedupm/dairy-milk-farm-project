...
Ver também [AGENTS.md](../../AGENTS.md) e a skill `atualizar-documentacao` (`.cursor/skills/atualizar-documentacao/SKILL.md`).
...
- **Verificação automatizada**: `node scripts/validate-br-refs.mjs` (CI) garante definição formal (heading/tabela), índice [`INDEX.md`](./INDEX.md) sincronizado (`node scripts/generate-br-index.mjs`), e alinhamento briefing↔estado (legado em [`pre-briefing-allowlist.txt`](./pre-briefing-allowlist.txt)).
...
| Links de eventos na ficha | [BR-CICLO-019.md](./BR-CICLO-019.md) | `BR-CICLO-019` | ✅ (BRF-008; detalhe de BR-ANIMAIS-013) |
...
| Coberturas (reprodução) | [coberturas.md](./coberturas.md) | ✅ (BR-COBERTURAS-008–011 — BRF-010) |
